...
<html>
					<div itemscope itemtype="http://schema.org/TelevisionChannel">
						<ul>
							<li><a href="/arenasport4.html"><span itemprop="name">ARENA SPORT 4 HD</span></a> <span itemprop="description">Canal de Deportes Yugoslavo</span></li>
														...
														<div id="aceplayer">
																	...
																	try {
																		var player = new TorrentStream.Player(controls.getPluginContainer(), {
																			...
																			onLoad: function() {
																				...
																				try {
																					var p = this;
																					this.loadPlayer("9ac492661cdd4d2450341bbd516318b70958a4d8", {autoplay: true}, {width: 100%});
																				}
																				catch(e) {
																					console.log("init: " + e);
																				}
															...
															<div id="aceplayer">
																...
																<script type="text/javascript">
																	...
																	plugin.playlistLoadAsyncPlayer("9ac492661cdd4d2450341bbd516318b70958a4d8");
																</script>
															</div>
														</div>
