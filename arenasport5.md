...
<html>
					<div itemscope itemtype="http://schema.org/TelevisionChannel">
						<ul>
							<li><a href="/arenasport5.html"><span itemprop="name">ARENA SPORT 5 HD</span></a> <span itemprop="description">Canal de Deportes Yugoslavo</span></li>
														...
														<div id="aceplayer">
																	...
																	try {
																		var player = new TorrentStream.Player(controls.getPluginContainer(), {
																			...
																			onLoad: function() {
																				...
																				try {
																					var p = this;
																					this.loadPlayer("151630758df5590f1da4399f018d83d6b5b49d71", {autoplay: true}, {width: 100%});
																				}
																				catch(e) {
																					console.log("init: " + e);
																				}
															...
															<div id="aceplayer">
																...
																<script type="text/javascript">
																	...
																	plugin.playlistLoadAsyncPlayer("151630758df5590f1da4399f018d83d6b5b49d71");
																</script>
															</div>
														</div>
