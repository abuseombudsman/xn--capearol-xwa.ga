...
<html>
					<div itemscope itemtype="http://schema.org/TelevisionChannel">
						<ul>
							<li><a href="/sporttv4.html"><span itemprop="name">SPORT TV 4 HD</span></a> <span itemprop="description">Canal de Deportes de Portugal</span></li>
														...
														<div id="aceplayer">
																	...
																	try {
																		var player = new TorrentStream.Player(controls.getPluginContainer(), {
																			...
																			onLoad: function() {
																				...
																				try {
																					var p = this;
																					this.loadPlayer("cdaa987788a6140c4460fa050ce3032b79f7f2dc", {autoplay: true}, {width: 100%});
																				}
																				catch(e) {
																					console.log("init: " + e);
																				}
															...
															<div id="aceplayer">
																...
																<script type="text/javascript">
																	...
																	plugin.playlistLoadAsyncPlayer("cdaa987788a6140c4460fa050ce3032b79f7f2dc");
																</script>
															</div>
														</div>
