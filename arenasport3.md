...
<html>
					<div itemscope itemtype="http://schema.org/TelevisionChannel">
						<ul>
							<li><a href="/arenasport3.html"><span itemprop="name">ARENA SPORT 3 HD</span></a> <span itemprop="description">Canal de Deportes Yugoslavo</span></li>
														...
														<div id="aceplayer">
																	...
																	try {
																		var player = new TorrentStream.Player(controls.getPluginContainer(), {
																			...
																			onLoad: function() {
																				...
																				try {
																					var p = this;
																					this.loadPlayer("41ac96dd8c2f84d2de3388e57c002717d83e1ee4", {autoplay: true}, {width: 100%});
																				}
																				catch(e) {
																					console.log("init: " + e);
																				}
															...
															<div id="aceplayer">
																...
																<script type="text/javascript">
																	...
																	plugin.playlistLoadAsyncPlayer("41ac96dd8c2f84d2de3388e57c002717d83e1ee4");
																</script>
															</div>
														</div>
