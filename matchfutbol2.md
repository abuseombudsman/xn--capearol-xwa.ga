...
<html>
					<div itemscope itemtype="http://schema.org/TelevisionChannel">
						<ul>
							<li><a href="/matchfutbol2.html"><span itemprop="name">MATCH! FUTBOL 2 HD</span></a> <span itemprop="description">Canal de Deportes Ruso</span></li>
														...
														<div id="aceplayer">
																	...
																	try {
																		var player = new TorrentStream.Player(controls.getPluginContainer(), {
																			...
																			onLoad: function() {
																				...
																				try {
																					var p = this;
																					this.loadPlayer("95aaf6bfa136a8103acae5cb952db66062107ac2", {autoplay: true}, {width: 100%});
																				}
																				catch(e) {
																					console.log("init: " + e);
																				}
															...
															<div id="aceplayer">
																...
																<script type="text/javascript">
																	...
																	plugin.playlistLoadAsyncPlayer("95aaf6bfa136a8103acae5cb952db66062107ac2");
																</script>
															</div>
														</div>
