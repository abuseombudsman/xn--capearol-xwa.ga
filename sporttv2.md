...
<html>
					<div itemscope itemtype="http://schema.org/TelevisionChannel">
						<ul>
							<li><a href="/sporttv2.html"><span itemprop="name">SPORT TV 2 HD</span></a> <span itemprop="description">Canal de Deportes de Portugal</span></li>
														...
														<div id="aceplayer">
																	...
																	try {
																		var player = new TorrentStream.Player(controls.getPluginContainer(), {
																			...
																			onLoad: function() {
																				...
																				try {
																					var p = this;
																					this.loadPlayer("89122d5e60866e9127a5f3849170031b16402adc", {autoplay: true});
																				}
																				catch(e) {
																					console.log("init: " + e);
																				}
															...
															<div id="aceplayer">
																...
																<script type="text/javascript">
																	...
																	plugin.playlistLoadAsyncPlayer("89122d5e60866e9127a5f3849170031b16402adc");
																</script>
															</div>
														</div>
