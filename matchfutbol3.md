														...
														<div id="aceplayer">
																	...
																	try {
																		var player = new TorrentStream.Player(controls.getPluginContainer(), {
																			...
																			onLoad: function() {
																				...
																				try {
																					var p = this;
																					this.loadPlayer("9de4faeff15442c2a793fb618cf876d3cc47f72b", {autoplay: true}, {width: 100%});
																				}
																				catch(e) {
																					console.log("init: " + e);
																				}
															...
															<div id="aceplayer">
																...
																<script type="text/javascript">
																	...
																	plugin.playlistLoadAsyncPlayer("9de4faeff15442c2a793fb618cf876d3cc47f72b");
																</script>
															</div>
														</div>
